...
ExecStart=/bin/bash -c 'source $HOME_DIR/initverse/.env && $HOME_DIR/initverse/iniminer-linux-x64 --pool stratum+tcp://${WALLET}.${NODE_NAME}@pool-a.yatespool.com:31588 --cpu-devices 1 --cpu-devices 2'Restart=on-failure
